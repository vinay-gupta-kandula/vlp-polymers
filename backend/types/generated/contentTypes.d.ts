...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer requirement inquiries';
    displayName: 'Inquiry';
  ...
  attributes: {
    ...
    productInterest: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLeadershipLeadership extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Company authorities and team members';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product Range catalog items';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    capacityLiters: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    category: Schema.Attribute.Enumeration<
      ['Boxes', 'Sheets', 'Beans', 'Pharma']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
